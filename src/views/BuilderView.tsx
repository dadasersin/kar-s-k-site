  ...
  return (
    <div className="p-4 lg:p-8 overflow-y-auto h-full pb-32 bg-brandDark">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-8">
        <div className="lg:col-span-1 glass-panel rounded-[32px] p-6 backdrop-blur-xl">
          ...
          <div className="space-y-3">
            {[
              ...
              <button
                ...
                className="w-full flex items-center gap-4 px-4 py-4 bg-black/40 border border-white/5 rounded-2xl text-gray-400 hover:text-primary hover:border-primary/30 transition-all text-xs font-bold uppercase tracking-widest"
              >
        ...
        <div className="lg:col-span-3 flex flex-col gap-6">
          <div className="flex-1 bg-black/40 border border-white/10 rounded-[40px] p-10 relative overflow-hidden flex flex-col min-h-[500px]">
            ...
            <div className="flex-1 border-2 border-dashed border-white/5 rounded-[32px] p-8 flex flex-col gap-4 overflow-y-auto scrollbar-hide">
              {components.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center opacity-20 py-20">
                  <i className="fas fa-plus-circle text-6xl mb-4 text-white"></i>
                  <p className="font-bold uppercase tracking-widest text-sm text-white">Bileşen eklemek için soldaki paneli kullanın</p>
                </div>
              ) : (
                components.map((c, i) => (
