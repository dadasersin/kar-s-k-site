                              ...
                              {components.map((c) => (
                                 ...
                                 >
                                    ...
                                    <div className="flex items-center gap-4 mb-8">
                                       <div className={`px-4 py-1.5 rounded-full text-[9px] font-black uppercase tracking-[0.2em] flex items-center gap-2 ${c.status === 'deployed' ? 'bg-green-500/20 text-green-400' :
