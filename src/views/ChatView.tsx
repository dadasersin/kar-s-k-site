...
const ChatView: React.FC<ChatViewProps> = ({ messages, setMessages, onSendMessage, isTyping, activeModelInfo }) => {
  ...
  const personas: Persona[] = [
    ...
    { id: '4', name: 'Asistan', role: 'Genel Yardımcı', icon: 'fa-robot', instructions: 'Sen Ersin Güleşin özel asistanısın. Her konuda yardımcı olmaya hazır ve saygılı bir dil kullan.' }
  ];
