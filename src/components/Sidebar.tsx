    ...
    <>
      ...
      <aside className="hidden md:flex w-64 flex-col glass-panel border-r border-slate-800 h-full shrink-0">
        ...
        <div className="p-5 border-t border-slate-800 bg-slate-900/20">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-slate-800 flex items-center justify-center border border-slate-700 cursor-pointer hover:bg-slate-700 transition-colors" onClick={onManualSync}>
              <i className={`fa-solid fa-plug-circle-bolt text-indigo-400 ${syncStatus === 'syncing' ? 'animate-pulse' : ''}`}></i>
            </div>
